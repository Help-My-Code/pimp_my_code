...
class RetrieveFollowByFollowerIdCubit extends Cubit<RetrieveFollowByFollowerIdState> {
  ...
  void loadFollowByFollowerId(String id) async {
    ...
    final users = await _findFollowByFollowerId(FindFollowByFollowerIdParam(id));
    users.fold((l) {
